// icon:wi-solar-eclipse | Weather Icons https://erikflowers.github.io/weather-icons/ | Eric Flowers
import * as React from "react";

function IconWiSolarEclipse(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            viewBox="0 0 30 30"
            fill="currentColor"
...
export default IconWiSolarEclipse;
